...
> maintained with the live Jodd website (source:
> [BBM-Co-ORG/Jodd-Homepage](https://github.com/BBM-Co-ORG/Jodd-Homepage), not
> this repo). Edit the policy in the website source, not here — this copy is
> kept only as an in-repo reference of what the live page says as of
> 2026-08-13.
>
> **Outstanding as of 2026-08-13:** the "Where your data is stored" section
> below has been updated in this in-repo copy to disclose at-rest encryption
> (shipped this date, see
> [docs/HISTORY.md](HISTORY.md)) — the live site still needs the same edit
> applied to `Jodd-Homepage`'s `privacy.html`.
