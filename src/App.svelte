<script lang="ts">
  ...
  import { isAuthenticated, notes, isLoading, isSaving, error, refreshNotes, accounts, activeAccounts, currentAccount, selectedNote, selectedFolder, recentlySavedUuids, recentSaveTimestamp, noteIndex, requestFolderRefresh, hydratedFolders, markFolderHydrated, selectedTags, setAccountNoteTags, selectedSmartFolder, smartFolderNotes, newNoteFn, lastPushConfirmation } from './lib/stores/notes';
