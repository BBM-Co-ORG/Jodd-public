<script lang="ts">
  ...
  import { isAuthenticated, notes, isLoading, isSaving, error, refreshNotes, accounts, activeAccounts, currentAccount, selectedNote, selectedFolder, recentlySavedUuids, recentSaveTimestamp, noteIndex, hydratedFolders, markFolderHydrated, selectedTags, setAccountNoteTags, selectedSmartFolder, smartFolderNotes, newNoteFn } from './lib/stores/notes';
