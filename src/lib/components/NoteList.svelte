<script lang="ts">
  ...
  import { notes, selectedFolder, selectedNote, isLoading, refreshNotes, currentAccount, activeAccounts, selectedUuids, clearSelectedUuids, selectedTags, tagMatchMode, toggleSelectedTag, noteTagsByAccount, getNoteTags, searchQuery, accountDisplay, selectedSmartFolder, smartFolderNotes, noteIndex, hydratedFolders, newNoteFn } from '../stores/notes';
        ...
        >
          ...
          >
            ...
            <div class="note-meta">
              ...
              <span class="note-preview" title={stripHtml(note.body_html)}>{stripHtml(note.body_html)}</span>
            </div>
