  ...
  <div class="sidebar-footer">
    ...
    {#if accountPanelOpen}
      <div class="account-panel" role="menu">
        ...
        {/if}
        {#if $isMacos}
          <!-- macOS only: the iCloud session lives in a per-webview
               persistent data store, a macOS 14+ API with no counterpart on
               the other desktop platforms. Windows and Android are M3.
