<script lang="ts">
  ...
  import { activeAccounts, notes, selectedNote, selectedFolder, refreshNotes, currentAccount, indexRemoveOnDelete, indexUpsertOnSave, noteTagsByAccount, getNoteTags, setNoteTags, setAccountNoteTags, accountDisplay } from '../stores/notes';
