<script lang="ts">
  ...
  import { selectedNote, notes, isSaving, error, currentAccount, markRecentlySaved, indexUpsertOnSave, indexRemoveOnDelete, tagsByAccount, setNoteTags, selectedFolder, searchQuery, activeAccounts, accountDisplay, selectedSmartFolder, toggleSelectedTag, clearSelectedTags } from '../stores/notes';
