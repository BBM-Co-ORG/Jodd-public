<script lang="ts">
  ...
  import { selectedNote, notes, isSaving, error, currentAccount, markRecentlySaved, indexUpsertOnSave, indexRemoveOnDelete, tagsByAccount, setNoteTags, selectedFolder, searchQuery, activeAccounts, accountDisplay, selectedSmartFolder, toggleSelectedTag, clearSelectedTags, capabilitiesByAccount, canWrite, needsPermanentDeleteConfirm } from '../stores/notes';
...
{#if $selectedNote}
  <div class="editor-pane">
    ...
    <div class="note-context">
      <span class="ctx-account" title="Account: {$selectedNote.account_id}">{accountDisplay($activeAccounts.find((a) => a.id === $selectedNote.account_id), $selectedNote.account_id ?? '')}</span>
    ...
    {#if permDeleteConfirmOpen}
      <ConfirmDialog
        ...
        message="This account has no Trash — the note will be deleted with no way to undo it."
