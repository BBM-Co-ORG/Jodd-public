...
<div class="auth-screen">
  <div class="auth-card">
    ...
    {/if}
    {#if $isMacos}
      <!-- macOS only: the session lives in a per-webview persistent data
           store, which is a macOS 14+ API with no counterpart on the other
           desktop platforms. Windows and Android are M3. -->
