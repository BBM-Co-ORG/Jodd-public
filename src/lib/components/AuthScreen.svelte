...
<div class="auth-screen">
  <div class="auth-card">
    ...
    <p class="description">
      Connect Gmail-backed Apple Notes on Windows, macOS, or Android.
      Gmail setup is intended for technical users in this preview.
    </p>
    <button class="google-btn" onclick={signIn} disabled={loading || !credentialsAvailable}>
      {#if phase === 'opening'}
